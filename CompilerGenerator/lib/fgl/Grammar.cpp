...
setting_rule.Set(::deamer::language::type::definition::object::main::NonTerminal("setting_rule", { setting_rule_TARGET_SETTING.Pointer(),setting_rule_MEMBER_SETTING.Pointer(),setting_rule_INCLUDE_SETTING.Pointer(),setting_rule_FUNCTION_SETTING.Pointer(),setting_rule_NAMINGCONVENTION_SETTING.Pointer(),setting_rule_DEAMER_LANGUAGE_NAME_SETTING.Pointer(),setting_rule_DISPATCH_SETTING.Pointer(),setting_rule_INHERITANCE_SETTING.Pointer(),setting_rule_USER_INSERTED_SETTING.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Group , false));
...
setting_rule_NAMINGCONVENTION_SETTING.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->NAMINGCONVENTION_SETTING.Pointer() }));
setting_rule_DEAMER_LANGUAGE_NAME_SETTING.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->DEAMER_LANGUAGE_NAME_SETTING.Pointer() }));
setting_rule_DISPATCH_SETTING.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->DISPATCH_SETTING.Pointer() }));
setting_rule_INHERITANCE_SETTING.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->INHERITANCE_SETTING.Pointer() }));
...
AddObject(setting_rule_NAMINGCONVENTION_SETTING);
AddObject(setting_rule_DEAMER_LANGUAGE_NAME_SETTING);
AddObject(setting_rule_DISPATCH_SETTING);
AddObject(setting_rule_INHERITANCE_SETTING);
