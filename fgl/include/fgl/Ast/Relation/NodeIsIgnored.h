#ifndef FGL_AST_RELATION_NODEISIGNORED_H
#define FGL_AST_RELATION_NODEISIGNORED_H

#include "fgl/Ast/Enum/Type.h"

namespace fgl { namespace ast { namespace relation { 

	constexpr static bool NodeIsIgnored(::fgl::ast::Type t)
	{
...
#endif // FGL_AST_RELATION_NODEISIGNORED_H