...
namespace fgl::ir::generate::cpp
{
	...
	public:
		...
		ConvertEnumToName(::fgl::ir::generate::cpp::VisitorTemplate::Type enumerationValue)
		{
			...
			case ::fgl::ir::generate::cpp::VisitorTemplate::Type::
				flavor_enum_to_type_conversion_case_: {
	...
	public:
		struct VariableBase
		{
			...
			::fgl::ir::generate::cpp::VisitorTemplate::Type type =
				::fgl::ir::generate::cpp::VisitorTemplate::Type::Unknown;
		...
		{
			::fgl::ir::generate::cpp::VisitorTemplate::ScopeType scope_type =
				::fgl::ir::generate::cpp::VisitorTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::fgl::ir::generate::cpp::VisitorTemplate::ScopeType scope_type_,
			...
			VariableScope(const char* text,
						  ::fgl::ir::generate::cpp::VisitorTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(::fgl::ir::generate::cpp::VisitorTemplate::ScopeType::DoubleColon_,
								true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::fgl::ir::generate::cpp::VisitorTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(
				::fgl::ir::generate::cpp::VisitorTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope(
				"\n",
				::fgl::ir::generate::cpp::VisitorTemplate::ScopeType::Variable_Field_Separator_,
				true);
	...
	public:
		struct Variable_accept_function_name_ : public VariableScopes
		{
			...
			Variable_accept_function_name_(VisitorTemplate* visitortemplate_,
		...
		struct Variable_action_id_ : public VariableScopes
		{
			...
			Variable_action_id_(VisitorTemplate* visitortemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::action_id_;
		...
		struct Variable_action_pop_ : public VariableScopes
		{
			...
			Variable_action_pop_(VisitorTemplate* visitortemplate_,
								 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::action_pop_;
		...
		struct Variable_action_push_ : public VariableScopes
		{
			...
			Variable_action_push_(VisitorTemplate* visitortemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::action_push_;
		...
		struct Variable_base_dispatch_function_ : public VariableScopes
		{
			...
			Variable_base_dispatch_function_(VisitorTemplate* visitortemplate_,
											 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::base_dispatch_function_;
		...
		struct Variable_const_qualifier_ : public VariableScopes
		{
			...
			Variable_const_qualifier_(VisitorTemplate* visitortemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::const_qualifier_;
		...
		struct Variable_constexpr_ : public VariableScopes
		{
			...
			Variable_constexpr_(VisitorTemplate* visitortemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::constexpr_;
		...
		struct Variable_dispatch_function_ : public VariableScopes
		{
			...
			Variable_dispatch_function_(VisitorTemplate* visitortemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::dispatch_function_;
		...
		struct Variable_entry_cases_ : public VariableScopes
		{
			...
			Variable_entry_cases_(VisitorTemplate* visitortemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::entry_cases_;
		...
		struct Variable_entry_conditional_ : public VariableScopes
		{
			...
			Variable_entry_conditional_(VisitorTemplate* visitortemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::entry_conditional_;
		...
		struct Variable_entry_manipulation_ : public VariableScopes
		{
			...
			Variable_entry_manipulation_(VisitorTemplate* visitortemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::entry_manipulation_;
		...
		struct Variable_entry_node_ : public VariableScopes
		{
			...
			Variable_entry_node_(VisitorTemplate* visitortemplate_,
								 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::entry_node_;
		...
		struct Variable_entry_object_type_ : public VariableScopes
		{
			...
			Variable_entry_object_type_(VisitorTemplate* visitortemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::entry_object_type_;
		...
		struct Variable_exit_cases_ : public VariableScopes
		{
			...
			Variable_exit_cases_(VisitorTemplate* visitortemplate_,
								 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::exit_cases_;
		...
		struct Variable_exit_node_ : public VariableScopes
		{
			...
			Variable_exit_node_(VisitorTemplate* visitortemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::exit_node_;
		...
		struct Variable_exit_object_type_ : public VariableScopes
		{
			...
			Variable_exit_object_type_(VisitorTemplate* visitortemplate_,
									   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::exit_object_type_;
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			Variable_file_(VisitorTemplate* visitortemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(visitortemplate_->header_guard_->This()),
					 GenerateVariable("\n#define "),
					 GenerateVariable(visitortemplate_->header_guard_->This()),
					 ...
					 GenerateVariable(visitortemplate_->flavoring_name_->This()),
					 GenerateVariable("();\n *\tflavoring"),
					 GenerateVariable("."),
					 ...
					 GenerateVariable(visitortemplate_->user_include_section_->Variable_Field()),
					 ...
					 GenerateVariable(visitortemplate_->flavor_value_->This()),
					 GenerateVariable("\n\t *\n\t *\t"),
					 GenerateVariable("\\"),
					 ...
					 GenerateVariable(
						 visitortemplate_->flavor_forward_declaration_->Variable_Field()),
					 GenerateVariable("\n\t\n\t// Compile time known flavor specialization type "
									  "forward declarations\n\t"),
					 GenerateVariable(visitortemplate_->flavor_specialization_forward_declaration_
										  ->Variable_Field()),
					 GenerateVariable("\n\n\t// Base flavor enumerations\n\t"),
					 GenerateVariable(visitortemplate_->flavor_type_definition_->This()),
					 GenerateVariable("\n\n\t// Specialization flavor enumerations\n\t"),
					 GenerateVariable(visitortemplate_->flavor_specialization_type_definition_
										  ->Variable_Field()),
					 GenerateVariable("\n\n\t// Flavor specialization enum to type conversion\n\t"),
					 GenerateVariable(
						 visitortemplate_->flavor_enum_to_type_conversion_->Variable_Field()),
					 GenerateVariable("\n\n\t/*!\t"),
					 GenerateVariable("\\"),
					 ...
					 GenerateVariable(visitortemplate_->optional_invalidation_counter_->This()),
					 ...
					 GenerateVariable(visitortemplate_->optional_invalidation_add_->This()),
					 GenerateVariable("\n\t\t"),
					 GenerateVariable(visitortemplate_->optional_invalidation_remove_->This()),
					 GenerateVariable("\n\n\t\t"),
					 GenerateVariable(visitortemplate_->optional_is_invalidated_check_->This()),
					 GenerateVariable("\n\t"),
					 GenerateVariable("}"),
					 GenerateVariable(";\n\n\t"),
					 GenerateVariable(visitortemplate_->flavor_specialization_->Variable_Field()),
					 GenerateVariable("\n\n\t"),
					 GenerateVariable(visitortemplate_->flavor_->Variable_Field()),
					 GenerateVariable("\n\n\t/*!\t"),
					 GenerateVariable("\\"),
					 ...
					 GenerateVariable("{"),
					 GenerateVariable("\n\tprivate:\n\t\t"),
					 GenerateVariable(visitortemplate_->flavor_declaration_->Variable_Field()),
					 GenerateVariable("\n\n\tprivate:\n\t\t"),
					 GenerateVariable(visitortemplate_->optional_flavor_action_stack_->This()),
					 GenerateVariable("\n\n\tpublic:\n\t\t"),
					 GenerateVariable(visitortemplate_->flavoring_name_->This()),
					 GenerateVariable("() = default;\n\t\t~"),
					 GenerateVariable(visitortemplate_->flavoring_name_->This()),
					 GenerateVariable("() = default;\n\n\tprivate:\n\t\t// Entry of nodes\n\t\t"),
					 GenerateVariable(visitortemplate_->entry_node_->Variable_Field()),
					 GenerateVariable("\n\n\t\t// Exit of nodes\n\t\t"),
					 GenerateVariable(visitortemplate_->exit_node_->Variable_Field()),
					 GenerateVariable("\n\t\n\tprivate:\n\t\t// Dispatch function\n\t\t"),
					 GenerateVariable(visitortemplate_->template_base_dispatch_function_->This()),
					 GenerateVariable("\n\n\t\t// Subtype dispatch functions\n\t\t"),
					 GenerateVariable(visitortemplate_->dispatch_function_->Variable_Field()),
					 GenerateVariable("\n\n\t// User defined members\n\tpublic:\n\t\t"),
					 GenerateVariable(visitortemplate_->user_member_section_->Variable_Field()),
					 GenerateVariable("\n\t\t\n\t// User defined functions\n\tpublic:\n\t\t"),
					 GenerateVariable(visitortemplate_->user_function_section_->Variable_Field()),
					 GenerateVariable("\n\n\t"),
					 GenerateVariable("}"),
					 GenerateVariable(";\n\n"),
					 GenerateVariable("}}"),
				...
				*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(visitortemplate_->output_name_->This())}));
		...
		struct Variable_flavor_ : public VariableScopes
		{
			...
			Variable_flavor_(VisitorTemplate* visitortemplate_,
							 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_;
		...
		struct Variable_flavor_action_stack_ : public VariableScopes
		{
			...
			Variable_flavor_action_stack_(VisitorTemplate* visitortemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_action_stack_;
		...
		struct Variable_flavor_count_type_ : public VariableScopes
		{
			...
			Variable_flavor_count_type_(VisitorTemplate* visitortemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_count_type_;
		...
		struct Variable_flavor_declaration_ : public VariableScopes
		{
			...
			Variable_flavor_declaration_(VisitorTemplate* visitortemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_declaration_;
		...
		struct Variable_flavor_enum_to_type_conversion_ : public VariableScopes
		{
			...
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::
					flavor_enum_to_type_conversion_;
			}

			virtual ~Variable_flavor_enum_to_type_conversion_() override = default;

			Variable_flavor_enum_to_type_conversion_(VisitorTemplate* visitortemplate_,
													 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::
		...
		struct Variable_flavor_enum_to_type_conversion_case_ : public VariableScopes
		{
			...
			Variable_flavor_enum_to_type_conversion_case_(
				VisitorTemplate* visitortemplate_, const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::
					flavor_enum_to_type_conversion_case_;
		...
		struct Variable_flavor_forward_declaration_ : public VariableScopes
		{
			...
			Variable_flavor_forward_declaration_(VisitorTemplate* visitortemplate_,
												 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_forward_declaration_;
		...
		struct Variable_flavor_invalidation_type_ : public VariableScopes
		{
			...
			Variable_flavor_invalidation_type_(VisitorTemplate* visitortemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_invalidation_type_;
		...
		struct Variable_flavor_name_ : public VariableScopes
		{
			...
			Variable_flavor_name_(VisitorTemplate* visitortemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_name_;
		...
		struct Variable_flavor_specialization_ : public VariableScopes
		{
			...
			Variable_flavor_specialization_(VisitorTemplate* visitortemplate_,
											const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_specialization_;
		...
		struct Variable_flavor_specialization_case_ : public VariableScopes
		{
			...
			Variable_flavor_specialization_case_(VisitorTemplate* visitortemplate_,
												 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_specialization_case_;
		...
		struct Variable_flavor_specialization_member_ : public VariableScopes
		{
			...
			{
				type =
					::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_specialization_member_;
			}

			virtual ~Variable_flavor_specialization_member_() override = default;

			Variable_flavor_specialization_member_(VisitorTemplate* visitortemplate_,
												   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_flavor_specialization_name_ : public VariableScopes
		{
			...
			Variable_flavor_specialization_name_(VisitorTemplate* visitortemplate_,
												 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_specialization_name_;
		...
		struct Variable_flavor_specialization_type_ : public VariableScopes
		{
			...
			Variable_flavor_specialization_type_(VisitorTemplate* visitortemplate_,
												 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_specialization_type_;
		...
		struct Variable_flavor_type_definition_ : public VariableScopes
		{
			...
			Variable_flavor_type_definition_(VisitorTemplate* visitortemplate_,
											 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_type_definition_;
		...
		struct Variable_flavor_type_name_ : public VariableScopes
		{
			...
			Variable_flavor_type_name_(VisitorTemplate* visitortemplate_,
									   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_type_name_;
		...
		struct Variable_flavor_value_ : public VariableScopes
		{
			...
			Variable_flavor_value_(VisitorTemplate* visitortemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavor_value_;
		...
		struct Variable_flavoring_name_ : public VariableScopes
		{
			...
			Variable_flavoring_name_(VisitorTemplate* visitortemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::flavoring_name_;
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			Variable_header_guard_(VisitorTemplate* visitortemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::header_guard_;
		...
		struct Variable_invalidation_add_ : public VariableScopes
		{
			...
			Variable_invalidation_add_(VisitorTemplate* visitortemplate_,
									   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::invalidation_add_;
		...
		struct Variable_invalidation_counter_ : public VariableScopes
		{
			...
			Variable_invalidation_counter_(VisitorTemplate* visitortemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::invalidation_counter_;
		...
		struct Variable_invalidation_remove_ : public VariableScopes
		{
			...
			Variable_invalidation_remove_(VisitorTemplate* visitortemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::invalidation_remove_;
		...
		struct Variable_is_invalidated_check_ : public VariableScopes
		{
			...
			Variable_is_invalidated_check_(VisitorTemplate* visitortemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::is_invalidated_check_;
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(VisitorTemplate* visitortemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::left_angle_bracket_;
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(VisitorTemplate* visitortemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::left_bracket_;
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(VisitorTemplate* visitortemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::left_curly_bracket_;
		...
		struct Variable_miror_manipulation_ : public VariableScopes
		{
			...
			Variable_miror_manipulation_(VisitorTemplate* visitortemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::miror_manipulation_;
		...
		struct Variable_object_base_type_ : public VariableScopes
		{
			...
			Variable_object_base_type_(VisitorTemplate* visitortemplate_,
									   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::object_base_type_;
		...
		struct Variable_object_type_ : public VariableScopes
		{
			...
			Variable_object_type_(VisitorTemplate* visitortemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::object_type_;
		...
		struct Variable_object_type_name_ : public VariableScopes
		{
			...
			Variable_object_type_name_(VisitorTemplate* visitortemplate_,
									   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::object_type_name_;
		...
		struct Variable_optional_action_pop_ : public VariableScopes
		{
			...
			Variable_optional_action_pop_(VisitorTemplate* visitortemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::optional_action_pop_;
		...
		struct Variable_optional_action_push_ : public VariableScopes
		{
			...
			Variable_optional_action_push_(VisitorTemplate* visitortemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::optional_action_push_;
		...
		struct Variable_optional_flavor_action_stack_ : public VariableScopes
		{
			...
			{
				type =
					::fgl::ir::generate::cpp::VisitorTemplate::Type::optional_flavor_action_stack_;
			}

			virtual ~Variable_optional_flavor_action_stack_() override = default;

			Variable_optional_flavor_action_stack_(VisitorTemplate* visitortemplate_,
												   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_optional_invalidation_add_ : public VariableScopes
		{
			...
			Variable_optional_invalidation_add_(VisitorTemplate* visitortemplate_,
												const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::optional_invalidation_add_;
		...
		struct Variable_optional_invalidation_counter_ : public VariableScopes
		{
			...
			{
				type =
					::fgl::ir::generate::cpp::VisitorTemplate::Type::optional_invalidation_counter_;
			}

			virtual ~Variable_optional_invalidation_counter_() override = default;

			Variable_optional_invalidation_counter_(VisitorTemplate* visitortemplate_,
													const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_optional_invalidation_remove_ : public VariableScopes
		{
			...
			{
				type =
					::fgl::ir::generate::cpp::VisitorTemplate::Type::optional_invalidation_remove_;
			}

			virtual ~Variable_optional_invalidation_remove_() override = default;

			Variable_optional_invalidation_remove_(VisitorTemplate* visitortemplate_,
												   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_optional_is_invalidated_check_ : public VariableScopes
		{
			...
			{
				type =
					::fgl::ir::generate::cpp::VisitorTemplate::Type::optional_is_invalidated_check_;
			}

			virtual ~Variable_optional_is_invalidated_check_() override = default;

			Variable_optional_is_invalidated_check_(VisitorTemplate* visitortemplate_,
													const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_optional_value_ : public VariableScopes
		{
			...
			Variable_optional_value_(VisitorTemplate* visitortemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::optional_value_;
		...
		struct Variable_output_name_ : public VariableScopes
		{
			...
			Variable_output_name_(VisitorTemplate* visitortemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::output_name_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(VisitorTemplate* visitortemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::right_angle_bracket_;
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(VisitorTemplate* visitortemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::right_bracket_;
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(VisitorTemplate* visitortemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::right_curly_bracket_;
		...
		struct Variable_sub_member_access_name_ : public VariableScopes
		{
			...
			Variable_sub_member_access_name_(VisitorTemplate* visitortemplate_,
											 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::sub_member_access_name_;
		...
		struct Variable_target_namespace_ : public VariableScopes
		{
			...
			Variable_target_namespace_(VisitorTemplate* visitortemplate_,
									   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::target_namespace_;
		...
		struct Variable_template_base_dispatch_function_ : public VariableScopes
		{
			...
			Variable_template_base_dispatch_function_(VisitorTemplate* visitortemplate_,
													  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::
		...
		struct Variable_user_function_section_ : public VariableScopes
		{
			...
			Variable_user_function_section_(VisitorTemplate* visitortemplate_,
											const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::user_function_section_;
		...
		struct Variable_user_include_section_ : public VariableScopes
		{
			...
			Variable_user_include_section_(VisitorTemplate* visitortemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::user_include_section_;
		...
		struct Variable_user_member_section_ : public VariableScopes
		{
			...
			Variable_user_member_section_(VisitorTemplate* visitortemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::user_member_section_;
		...
		struct Variable_value_ : public VariableScopes
		{
			...
			Variable_value_(VisitorTemplate* visitortemplate_,
							const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::value_;
		...
		struct Variable_visit_function_name_ : public VariableScopes
		{
			...
			Variable_visit_function_name_(VisitorTemplate* visitortemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::fgl::ir::generate::cpp::VisitorTemplate::Type::visit_function_name_;
	...
	public:
		VisitorTemplate()
		{
			...
			*entry_node_ = Variable_entry_node_(
				...
				std::vector<VariableBase*>(
					{GenerateVariable("void "), GenerateVariable(entry_object_type_->This()),
					 GenerateVariable("("), GenerateVariable(target_namespace_->This()),
					 GenerateVariable("::"), GenerateVariable(object_type_->This()),
					 GenerateVariable("* node)\n"), GenerateVariable("{"), GenerateVariable("\n\t"),
			...
			*output_name_ = Variable_output_name_(
				this, std::vector<VariableBase*>({GenerateVariable("Visitor")}));
